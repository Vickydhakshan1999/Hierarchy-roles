...
# from djangoRestProject import settings
...
class CustomFieldBase(models.Model):
    ...
    if tenant_model:
        tenant = models.ForeignKey(
            tenant_model, on_delete=models.CASCADE, null=True, default=None
        )
...
class CustomFieldValueBase(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=CUSTOM_FIELD_VALUE_STATUS, default=CUSTOM_FIELD_VALUE_STATUS[1][0]
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
